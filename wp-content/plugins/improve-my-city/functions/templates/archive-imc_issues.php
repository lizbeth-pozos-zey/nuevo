...
$imported_order_label = __('Date', 'improve-my-city');
if ($imported_order == '2') {$imported_order_label = __('Votes', 'improve-my-city'); }
...
$gridSelectedClass = $imported_view == '1' ? 'imc-NavSelectedStyle' : '' ;
$listSelectedClass = $imported_view == '1' ? '' : 'imc-NavSelectedStyle' ;
?>
                ...
                <li>
                    <label class="imc-NaviSelectStyle">
                        <select id="imcSelectDisplayComponent" title="Issues to display" onchange="imcFireNavigation('imcSelectDisplayComponent')">
                            <option class="imc-CustomOptionDisabledStyle" value="<?php echo esc_attr($imported_ppage); ?>" selected disabled><?php echo __('Display: ', 'improve-my-city'); ?> <?php echo esc_html($imported_ppage_label); ?></option>
                            ...
                            <option value="<?php echo esc_url( $my_permalink . imcCreateFilterVariablesLong($perma_structure, $issues_per_page = '-1', $imported_order, $imported_view, $imported_sstatus, $imported_scategory, $imported_keyword) ); ?>"><?php echo __('All', 'improve-my-city'); ?></option>
                        </select>
                    </label>
                </li>
                ...
                <li>
                    <label class="imc-NaviSelectStyle">
                        <select id="imcSelectOrderingComponent" title="Order by" onchange="imcFireNavigation('imcSelectOrderingComponent')">
                            <option class="imc-CustomOptionDisabledStyle" value="<?php echo esc_attr($imported_order); ?>" selected disabled><?php echo __('Order: ', 'improve-my-city'); ?>  <?php echo esc_html($imported_order_label); ?></option>

                            <option value="<?php echo esc_url( $my_permalink . imcCreateFilterVariablesLong($perma_structure, $imported_ppage, $theorder = '1', $imported_view, $imported_sstatus, $imported_scategory, $imported_keyword) ); ?>"><?php echo __('Date', 'improve-my-city'); ?></option>
                            <option value="<?php echo esc_url( $my_permalink . imcCreateFilterVariablesLong($perma_structure, $imported_ppage, $theorder = '2', $imported_view, $imported_sstatus, $imported_scategory, $imported_keyword) ); ?>"><?php echo __('Votes', 'improve-my-city'); ?></option>
                        </select>
                    </label>
                </li>

                <li class="imc-hidden-xs"><a href="<?php echo esc_url( $my_permalink . imcCreateFilterVariablesLong($perma_structure, $imported_ppage, $imported_order, $theview = '1', $imported_sstatus, $imported_scategory, $imported_keyword) ); ?>" class="imc-SingleHeaderLinkStyle <?php echo $gridSelectedClass; ?>"><i class="material-icons md-36 imc-VerticalAlignMiddle">view_stream</i></a></li>
                <li class="imc-hidden-xs"><a href="<?php echo esc_url( $my_permalink . imcCreateFilterVariablesLong($perma_structure, $imported_ppage, $imported_order, $theview = '2', $imported_sstatus, $imported_scategory, $imported_keyword) ); ?>" class="imc-SingleHeaderLinkStyle <?php echo $listSelectedClass; ?>"><i class="material-icons md-36 imc-VerticalAlignMiddle">apps</i></a></li>

                <li class="u-pull-right imc-hidden-xs">
                    <a href="<?php echo esc_url( get_permalink($insertpage[0]->ID) ); ?>" class="imc-SingleHeaderLinkStyle">
                        ...
                        <span class="imc-hidden-xs imc-hidden-sm"><?php echo __('Report an issue','improve-my-city'); ?></span>
                    </a>
                </li>
    ...
    <div class="imc-visible-xs imc-hidden-sm imc-hidden-lg imc-hidden-xl imc-hidden-md imc-SingleHeaderStyle imc-BGColorWhite">
        <nav class="imc-OverviewHeaderNavStyle">
            <ul class="imc-OverviewNavUlStyle">
        ...
        <div class="ac-container">
            ...
            <div class="imc-SingleHeaderStyle imc-BGColorWhite">
                <label for="ac-1" class="imc-OverviewFilteringPanelLabelStyle">
                    <span><?php echo __('Search &amp; Filtering', 'improve-my-city'); ?></span>
                    <span style="display: none;" id="imcCatFilteringLabel" class="u-pull-right imc-OverviewFilteringLabelStyle"><?php echo __('Category', 'improve-my-city');?></span>
                    <span style="display: none;" id="imcStatFilteringLabel" class="u-pull-right imc-OverviewFilteringLabelStyle"><?php echo __('Status', 'improve-my-city');?></span>
                    <span style="display: none;" id="imcKeywordFilteringLabel" class="u-pull-right imc-OverviewFilteringLabelStyle"><?php echo __('Keyword', 'improve-my-city');?></span>
            ...
            <article class="ac-small imc-DropShadow">
                ...
                <div class="imc-row imc-DrawerContentsStyle">
                    ...
                    <div class="imc-DrawerFirstCol">
                        <h3 class="imc-SectionTitleTextStyle"><?php echo __('Search', 'improve-my-city'); ?></h3>

                        <input name="searchKeyword" autocomplete="off" placeholder="<?php echo __('Keyword search','improve-my-city'); ?>" id="imcSearchKeywordInput" type="search" class="imc-InputStyle"/>
                        ...
                        <label class="imc-SectionTitleTextStyle" for="imcToggleStatusCheckbox"><?php echo __('Issue status', 'improve-my-city'); ?></label>
                        <br>
                    ...
                    <div class="imc-DrawerSecondCol">
                        ...
                        <label class="imc-SectionTitleTextStyle" for="imcToggleCatsCheckbox"><?php echo __('Categories', 'improve-my-city'); ?></label>
                        <br>
                ...
                <div class="imc-row-no-margin imc-DrawerButtonRowStyle">
                    <button class="imc-button imc-button-primary u-pull-right" onclick="imcOverviewGetFilteringData();"><?php echo __('Apply filters', 'improve-my-city'); ?></button>
                    <button class="imc-button u-pull-right" onclick="imcOverviewResetFilters();"><?php echo __('Reset filters', 'improve-my-city'); ?></button>
                </div>
    ...
    <div class="imc-BGColorGray imc-OverviewWrapperStyle">
        ...
        <div class="imc-OverviewContentStyle">
            ...
            <div class="imc-OverviewIssuesContainerStyle" id="imcOverviewContainer">
				...
				if ($custom_query->have_posts()) :
                    ...
                    <div class="imc-row imc-CenterContents imc-GiveWhitespaceStyle">
                        ...
                        <h1 class="imc-FontRoboto imc-Text-XL imc-TextColorSecondary imc-TextItalic imc-TextMedium imc-CenterContents"><?php echo __('There are no issues','improve-my-city'); ?></h1>

                        <div class="imc-Separator"></div>

                        <span class="imc-CenterContents imc-TextMedium imc-Text-LG imc-FontRoboto">
							<a href="<?php echo esc_url( get_permalink($insertpage[0]->ID) ); ?>" class="imc-LinkStyle"><?php echo __('Add a new issue','improve-my-city'); ?></a>
							<?php if($filtering_active) { ?>
                                <span class="imc-TextColorSecondary ">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                                <a href="javascript:void(0);" onclick="imcOverviewResetFilters();" class="imc-LinkStyle"><?php echo __('Reset filters','improve-my-city'); ?></a>
							<?php } ?>
						</span>
            ...
            <div class="imc-OverviewPaginationContainerStyle">
                ...
                <p class="img-PaginationLabelStyle imc-TextColorSecondary"><?php echo __('Showing','improve-my-city'); ?> <b><?php echo esc_html($start_indicator); ?></b> - <b><?php echo esc_html($end_indicator) ?></b> <?php echo __('of','improve-my-city'); ?> <b><?php echo esc_html($total_issues) ?></b> <?php echo __('issues','improve-my-city'); ?></p>
    ...
    <script>
        ...
        function imcOverviewGetFilteringData() {
            ...
            jQuery('#imcStatusCheckboxes input:checkbox:not(:checked)').each(function() {
                selectedStatus.push(jQuery(this).attr('value'));
            });
            selectedStatus = selectedStatus.toString();

            jQuery('#imcCatCheckboxes input:checkbox:not(:checked)').each(function() {
                selectedCats.push(jQuery(this).attr('value'));
            });
            selectedCats = selectedCats.toString();

            keywordString = jQuery('#imcSearchKeywordInput').val() ? jQuery('#imcSearchKeywordInput').val() : '';
